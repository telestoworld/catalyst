import { discretizedPositionDistance, Position3D } from 'telestoworld-katalyst-utils/Positions'
...
describe('Discretize Positions', () => {
  ...
  it('should preserve higher distances when they are in different intervals', () => {
    ...
    expect(discretizedPositionDistance()(origin, position1)).toBeLessThan(
      discretizedPositionDistance()(origin, position2)
    )
  })
  ...
  it('should calculate according to the intervals', () => {
    ...
    expect(discretizedPositionDistance()(origin, [90, 90, 90])).toEqual(4)
    expect(discretizedPositionDistance()(origin, [150, 150, 150])).toEqual(5)
  })
})
