      ...
      return (
        <div>
          <img
            width={50}
            alt="User avatar"
            src={props.contentServer + 'contents/' + props.userInfo[0].metadata.avatars[0].avatar.snapshots.face}
          />
          &nbsp;
    ...
    return (
      <div>
        <img
          width={50}
          alt="Default avatar"
          src={props.contentServer + 'contents/QmeLTsRbiPpgW5ir1q1Ny3dG5znDGRSvWZCBuMgkxV7us9'}
        />
      </div>
    )
  }
